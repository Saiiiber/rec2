 ...
 * @author u10549640177
 */
public class JDlgCliente1 extends javax.swing.JDialog {
 boolean incl; 
  MaskFormatter maskdata;
    /**
     * Creates new form JDlgUsuarios
     */
    public JDlgCliente1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Entregas");
        ...
        try {
            ...
            Logger.getLogger(JDlgCliente1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jBtnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnPesquisarActionPerformed
        // TODO add your handling code here:
        JDlgCliente_pesquisar jDLgUsuarios_cliente = new JDlgCliente_pesquisar(null, true);

        jDLgUsuarios_cliente.setTelaAnterior(this);
        jDLgUsuarios_cliente.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgCliente1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgCliente1 dialog = new JDlgCliente1(new javax.swing.JFrame(), true);
